...
const ROLES: RoleData[] = [
  {
    ...
    period: "2024 – PRESENT",
    context: "Global prop trading firm · 100K+ traders · Nx microservices platform",
    bullets: [
      "Owned central dashboards for 100K+ users (70K active); smart polling aligned to 30s backend sync.",
      "Worked across 20+ microservices and 100+ shared libraries; owned 3 services end-to-end.",
      "Reduced external API costs by 30–40% via Redis cache-first architecture.",
      "Standardized React Query company-wide — patterns, cache strategy, invalidation rules.",
      "Trained 6 teams (~18–24 developers) on architecture, theming, i18n, and best practices.",
    ],
  ...
  },
  {
    ...
    title: "Full Stack Engineer",
    period: "2023 – 2024",
    context: "Software studio under SQLink · End-to-end product engineering for startups",
    bullets: [
      "Delivered 8+ client systems across React, Node/Nest/Express, and Laravel.",
      "Built AI chat systems, a complex insurance platform (8+ API integrations), and mobile tracking apps.",
      "Delivered Contest Leaderboard with 16+ UX states, responsive layouts, dark/light modes.",
    ],
    tech: ["React", "TypeScript", "NestJS", "Vue.js", "Docker", "AWS", "MongoDB"],
    accent: "#6366f1",
  },
  {
    company: "Restigo",
    ...
    period: "2022 – 2023",
    context: "B2B SaaS for hospitality · Burger King, Shake Shack, Papa Johns",
    bullets: [
      "Promoted to Team Lead in 9 months — managed 3 developers, owned full-stack delivery.",
      "Introduced CI/CD pipelines, PR culture, code reviews, and daily standups.",
      "Modernized legacy UI: jQuery → React; optimized MySQL performance.",
    ],
    tech: ["React", "TypeScript", "PHP", "Laravel", "MySQL", "CI/CD", "Git"],
    accent: "#f59e0b",
  },
  {
    company: "ASML",
    ...
    period: "2018 – 2022",
    context: "World's sole EUV lithography manufacturer · Intel fabs worldwide",
    bullets: [
      "Deployed across Intel fabs — Oregon, Ireland, Israel — supporting mission-critical lithography systems.",
      "Managed hardware & software troubleshooting under strict fab uptime constraints.",
      "Responsible for UNIX/Linux administration; MATLAB data analysis on machine performance.",
    ],
    tech: ["Linux / Unix", "MATLAB", "System Admin", "Hardware Troubleshooting"],
    isOriginStory: true,
    originQuote: "Debugging million-dollar machines under fab-uptime pressure shaped every system I build today.",
    accent: "#64748b",
  },
];
